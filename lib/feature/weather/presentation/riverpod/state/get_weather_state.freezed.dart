...
class __$$GetWeatherCopyWithImpl<$Res>
    extends _$WeatherStateCopyWithImpl<$Res, _$GetWeather>
...
class _$GetWeather implements GetWeather {
  const _$GetWeather({required this.weatherEntity});
  ...
  @override
  String toString() {
    return 'WeatherState.getWeather(weatherEntity: $weatherEntity)';
  }
...
abstract class GetWeather implements WeatherState {
  const factory GetWeather({required final WeatherEntity weatherEntity}) =
      _$GetWeather;
